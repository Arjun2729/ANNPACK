...
- [ ] For every public third-party pack, record source URL, immutable revision, source license, redistribution basis, build command, pack root, signing key, and refresh owner. Do not publish a ten-project catalog first and resolve provenance later.
...
Show HN, vendor outreach, and headline performance claims follow these gates; they are not substitutes for them.
