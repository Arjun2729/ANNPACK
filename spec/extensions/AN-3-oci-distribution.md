...
AN-3 maps one pack to one OCI artifact layer as defined by [the media-type registry](../MEDIA-TYPES.md). Clients verify OCI SHA-256 descriptors and then independently verify the ANNPack BLAKE3 root and sections.
