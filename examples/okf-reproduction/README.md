...
These roots compile the pinned OKF v0.2 source with `annpack-reference/0.5.1`. They identify this builder's exact artifact bytes; the reproduction script and CI fail on any unreviewed drift.
